...
- Descriptive_Analytics_Notebook → Summary statistics and distributions
- Predictive_Analytics_Notebook → Forecasting, churn, demand planning
- Prescriptive_Analytics_Notebook → KPI dashboards and optimization
- screenshots/ → PBIX page previews
  - EDA_Page.png
  - DiagAnalytics_Page.png
  - Predictions_Page.png
  - PrescriptiveAnalytics_Page.png
